...
-- 7. Add a new product: bookshelf

INSERT INTO products (name, price, can_be_returned) VALUES ('bookshelf', 75.00, TRUE);
...
-- 11. Sale: Subtract $20 from all prices

UPDATE products SET price = price - 20;

-- 12. Remove products with price < 25

DELETE FROM products WHERE price < 25;

-- 13. End of sale: Add $20 back to all remaining products

UPDATE products SET price = price + 20;

-- 14. New policy: All products are returnable
