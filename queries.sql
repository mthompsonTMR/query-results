...
SELECT category, COUNT(*) FROM analytics GROUP BY category ORDER BY COUNT(*) DESC;
...
-- 15. Find the app that has the highest proportion of min_installs to reviews (at least 100,000 installs).
